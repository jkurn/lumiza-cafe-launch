...
export const menuCategories: MenuCategory[] = [
  // ── BREAKFAST MENU ──
  {
    ...
    items: [
      ...
      { name: "BLAT Roll", description: "Bacon, lettuce, avocado, tomato", price: "$12.50" },
      ...
      { name: "Avo Smash", description: "Smashed avo w/ tomato and feta on sourdough", price: "$11.90", tag: "veggie" },
      ...
      { name: "Big Lumiza", description: "Artisan sourdough, two eggs your way, bacon, sausage, mushrooms, grilled tomato & baby spinach", price: "$21.90", tag: "popular" },
      { name: "Omelettes w/ Toast", description: "Choose: ham/tomato/onions/cheese, chicken/cheese/onions/mushrooms, tomato/mushrooms/spinach/cheese", price: "$16.90" },
      { name: "Chorizo Omelette", description: "Chorizo, cheese, capsicum & olives w/ toast", price: "$18.90" },
    ],
  },
  {
  ...
  // ── LUNCH MENU ──
  {
    ...
    items: [
      ...
      { name: "Classic Chicken Burger", description: "Grilled chicken breast, mixed leaves, cheese and mayo", price: "$12.00" },
    ],
  },
  {
    title: "Mexican Style",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Chicken Caesar Salad", description: "Caesar salad topped with grilled chicken", price: "$19.90" },
      { name: "Chicken Avocado Salad", description: "Grilled chicken with fresh avocado salad", price: "$18.90" },
    ],
  },
  {
    title: "Pastas",
    items: [
      ...
      { name: "Alfredo", description: "Choose spaghetti, fettuccini, beef tortellini or penne", price: "$13.90" },
      { name: "Garlic Prawns", description: "Choose spaghetti, fettuccini, beef tortellini or penne", price: "$19.90" },
    ],
  },
  {
    title: "Sides",
